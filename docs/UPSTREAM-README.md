> **Preserved upstream README** — this is the original framework README from [MadsLorentzen/ai-job-search](https://github.com/MadsLorentzen/ai-job-search) (MIT), kept unchanged for reference when this fork replaced the root README; relative links and images below resolve from the repository root, not from docs/.
